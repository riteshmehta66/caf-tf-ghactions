network_security_group_definition = {
  ...
  eus2_nsg_default = {
    ...
    name               = "mgt-{{configs.environment}}-00-ss-00-00-a-nsg-def-e2"    
    version             = 1
    ...
    nsg = [
      ...
      // },
      {
        name                       = "mgt-{{configs.environment}}-non-aks-e2cidr-Allow-e2",
        priority                   = "1000"
        direction                  = "Inbound"
        access                     = "Allow"
        protocol                   = "*"
      ...
      {
        name                       = "mgt-{{configs.environment}}-aks-e2cidr-Allow-e2",
        priority                   = "1001"
        direction                  = "Inbound"
        access                     = "Allow"
        protocol                   = "*"
      ...
      {
        name                       = "mgt-{{configs.environment}}-non-aks-c1cidr-Allow-e2",
        priority                   = "1002"
        direction                  = "Inbound"
        access                     = "Allow"
        protocol                   = "*"
      ...
      {
        name                       = "mgt-{{configs.environment}}-aks-c1cidr-Allow-e2",
        priority                   = "1003"
        direction                  = "Inbound"
        access                     = "Allow"
        protocol                   = "*"
  ...
  cus_nsg_default = {
    ...
    name               = "mgt-{{configs.environment}}-00-ss-00-00-a-nsg-def-c1"    
    version             = 1
    ...
    nsg = [
      ...
      // },
      {
        name                       = "mgt-{{configs.environment}}-non-aks-e2cidr-Allow-c1",
        priority                   = "1000"
        direction                  = "Inbound"
        access                     = "Allow"
        protocol                   = "*"
      ...
      {
        name                       = "mgt-{{configs.environment}}-aks-e2cidr-Allow-c1",
        priority                   = "1001"
        direction                  = "Inbound"
        access                     = "Allow"
        protocol                   = "*"
      ...
      {
        name                       = "mgt-{{configs.environment}}-non-aks-c1cidr-Allow-c1",
        priority                   = "1002"
        direction                  = "Inbound"
        access                     = "Allow"
        protocol                   = "*"
      ...
      {
        name                       = "mgt-{{configs.environment}}-aks-c1cidr-Allow-c1",
        priority                   = "1003"
        direction                  = "Inbound"
        access                     = "Allow"
        protocol                   = "*"
