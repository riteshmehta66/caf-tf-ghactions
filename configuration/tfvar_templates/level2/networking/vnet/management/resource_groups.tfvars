resource_groups = {
  eus2_vnet_rg_01 = {
    name   = "mgt-{{configs.environment}}-00-ss-00-00-a-rg-vnet-e2"
    region = "region1"
    tags   = {
  ...
  cus_vnet_rg_01 = {
    name   = "mgt-{{configs.environment}}-00-ss-00-00-a-rg-vnet-c1"
    region = "region2"
    tags   = {
      "application name"  = "shared services mgt"
      "{{configs.environment}} hours" =  "{{configs.tag_value_hours1}}"
  ...
  // eus2_nsg_rg_01 = {
  //   name   = "mgt-{{configs.environment}}-00-ss-00-00-a-rg-nsg-e2"
  //   region = "region1"  
  // }

  // cus_nsg_rg_01 = {
  //   name   = "mgt-{{configs.environment}}-00-ss-00-00-a-rg-nsg-c1"
  //   region = "region2" 
  // }
