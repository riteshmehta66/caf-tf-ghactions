...
vnets = {
  eus2_vnet_01 = {
    ...
    region             = "region1"
    vnet = {
      name          = "idm-sbx-00-idm-00-mhb-a-vnet-00-e2"
    ...
    subnets = {
      ...
      eus2_vnet_01_snet_01 = {
        name                                           = "idm-sbx-00-idm-00-mhb-a-snet-ad1-e2"
        cidr                                           = ["10.136.68.0/26"]
  ...
  cus_vnet_01 = {
    ...
    region             = "region2"
    vnet = {
      name          = "idm-sbx-00-idm-00-mhb-a-vnet-00-c1"
    ...
    subnets = {
      ...
      cus_vnet_01_snet_01 = {
        name                                           = "idm-sbx-00-idm-00-mhb-a-snet-ad1-c1"
        cidr                                           = ["10.140.68.0/26"]
