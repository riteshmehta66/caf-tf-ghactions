...
azurerm_firewalls = {
  eus2_azfw1 = {
    name                = "con-sbx-hub-ntw-00-00-a-afw-00-e2"
  ...
  cus_azfw1 = {
    name                = "con-sbx-hub-ntw-00-00-a-afw-00-c1"
...
azurerm_firewall_policies = {
  eus2_azfw_policy1 = {
    name               = "con-sbx-hub-ntw-00-00-a-afwp-00-e2"
    resource_group_key = "eus2_vnet_rg_01"
    region             = "region1"
  }

  cus_azfw_policy1 = {
    name               = "con-sbx-hub-ntw-00-00-a-afwp-00-c1"
    resource_group_key = "cus_vnet_rg_01"
    region             = "region2"
  }
}
...
azurerm_firewall_policy_rule_collection_groups = {
  ...
  eus2_aks_rcg1 = {
    ...
    firewall_policy_key = "eus2_azfw_policy1"
    name                = "con-sbx-hub-ntw-00-00-a-afwp-cgaks-e2"
    priority            = 10001

    network_rule_collections = {
      aks = {
        name     = "con-sbx-hub-ntw-00-00-a-afwp-craks-e2"
        priority = 1000
        action   = "Allow"
        rules = {         
          aks_https_in_allow = {
            ...
            protocols             = ["TCP"]
            source_addresses      = ["*"]
            destination_addresses = ["10.136.96.0/20","10.136.95.0/24"]
  ...
  eus2_vnets_rcg1 = {
    #firewall_policy_id = "Azure Resource ID"
    firewall_policy_key = "eus2_azfw_policy1"
    name                = "con-sbx-hub-ntw-00-00-a-afwp-cgvnet-e2"
    priority            = 10002

    network_rule_collections = {
      eus2_vnets_allow = {
        name     = "con-sbx-hub-ntw-00-00-a-afwp-crvnet-e2"
        priority = 1000
        action   = "Allow"
        rules = {
          ...
          eus2_to_internet = {
            ...
            protocols             = ["Any"]
            source_addresses      = ["10.136.64.0/18"]
          ...
          eus2_to_eus2 = {
            ...
            protocols             = ["Any"]
            source_addresses      = ["10.136.64.0/18"]
            destination_addresses = ["10.136.64.0/18"]
            destination_ports     = ["*"]
          }
          eus2_to_cus = {
            ...
            protocols             = ["Any"]
            source_addresses      = ["10.136.64.0/18"]
            destination_addresses = ["10.140.64.0/18"]
            destination_ports     = ["*"]
          }
          cus_to_eus2 = {
            name                  = "allow_cus_to_eus2"
            protocols             = ["Any"]
            source_addresses      = ["10.140.64.0/18"]
            destination_addresses = ["10.136.64.0/18"]
            destination_ports     = ["*"]
          }                           
        }
  ...
  cus_aks_rcg1 = {
    #firewall_policy_id = "Azure Resource ID"
    firewall_policy_key = "cus_azfw_policy1"
    name                = "con-sbx-hub-ntw-00-00-a-afwp-cgaks-c1"
    priority            = 10001

    network_rule_collections = {
      aks = {
        name     = "con-sbx-hub-ntw-00-00-a-afwp-craks-c1"
        priority = 1000
        action   = "Allow"
        rules = {
          // aks_http_in_allow = {
  ...
  cus_vnets_rcg1 = {
    #firewall_policy_id = "Azure Resource ID"
    firewall_policy_key = "cus_azfw_policy1"
    name                = "con-sbx-hub-ntw-00-00-a-afwp-cgvnet-c1"
    priority            = 10002

    network_rule_collections = {
      cus_vnets_allow = {
        name     = "con-sbx-hub-ntw-00-00-a-afwp-crvnet-c1"
        priority = 1000
        action   = "Allow"
        rules = {
