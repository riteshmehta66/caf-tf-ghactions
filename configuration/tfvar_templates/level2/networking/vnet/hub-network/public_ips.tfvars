...
public_ip_addresses = {
  eus2_azfw_pip1 = {
    name               = "con-{{configs.environment}}-hub-ntw-00-00-a-pip-afw-e2"
  ...
  // eus2_azfw_mgmt_pip1 = {
  //   name               = "con-{{configs.environment}}-hub-ntw-00-00-a-pip-afwmgt-e2"
  //   resource_group_key = "eus2_vnet_rg_01"
  ...
  cus_azfw_pip1 = {
    name               = "con-{{configs.environment}}-hub-ntw-00-00-a-pip-afw-c1"
  ...
  // cus_azfw_mgmt_pip1 = {
  //   name               = "con-{{configs.environment}}-hub-ntw-00-00-a-pip-afwmgt-c1"
  //   resource_group_key = "cus_vnet_rg_01"
  //   sku                = "Standard"             # must be 'Standard' SKU for Azure Firewall
  //   # Standard SKU Public IP Addresses that do not specify a zone are zone redundant by default.
  //   allocation_method       = "Static"          # must be 'Static' for Azure Firewall 
  ...
  eus2_bastion_host_pip_01 = {
    name                    = "con-{{configs.environment}}-hub-ntw-00-00-a-pip-bas-e2"
    region                  = "region1"
    resource_group_key      = "eus2_vnet_rg_01"
    sku                     = "Standard"
    allocation_method       = "Static"
  ...
  cus_bastion_host_pip_01 = {
    name                    = "con-{{configs.environment}}-hub-ntw-00-00-a-pip-bas-c1"
    region                  = "region2"
    resource_group_key      = "cus_vnet_rg_01"
    sku                     = "Standard"
    allocation_method       = "Static"
