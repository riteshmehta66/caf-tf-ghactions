...
caf_environment="mhb-sbx-ritesh"
...
#   -var-folder /tf/caf/mhb-iac-platform/configuration/sbx/level0/launchpad \
#   -parallelism 30 \
#   -level level0 \
#   -launchpad \
#   -env ${caf_environment} \
...
#   -tfstate_subscription_id ${TF_VAR_tfstate_subscription_id} \
#   -target_subscription "MS-SandBox" \
#   -var-folder /tf/caf/mhb-iac-platform/configuration/sbx/level1/management \
#   -var-file /tf/caf/mhb-iac-platform/configuration/sbx/level1/diagnostics_definition.tfvars \
#   -parallelism 30 \
...
/tf/rover/rover.sh -lz /tf/caf/landingzones/caf_solution  \
  ...
  -var-folder /tf/caf/mhb-iac-platform/configuration/sbx/level2/networking/vnet/hub-network   \
  -parallelism 30   \
  -level level2   \
  -env ${caf_environment}   \
  -a apply
...
/tf/rover/rover.sh -lz /tf/caf/landingzones/caf_solution \
  ...
  -var-folder /tf/caf/mhb-iac-platform/configuration/sbx/level2/networking/vnet/identity \
  -parallelism 30 \
  -level level2 \
  -env ${caf_environment} \
  -a apply
...
/tf/rover/rover.sh -lz /tf/caf/landingzones/caf_solution \
  ...
  -var-folder /tf/caf/mhb-iac-platform/configuration/sbx/level2/networking/vnet/management \
  -parallelism 30 \
  -level level2 \
  -env ${caf_environment} \
  -a apply
...
/tf/rover/rover.sh -lz /tf/caf/landingzones/caf_solution \
  ...
  -var-folder /tf/caf/mhb-iac-platform/configuration/sbx/level2/networking/vnet/bynlz \
  -parallelism 30 \
  -level level2 \
  -env ${caf_environment} \
  -a apply
...
/tf/rover/rover.sh -lz /tf/caf/landingzones/caf_solution \
  ...
  -var-folder /tf/caf/mhb-iac-platform/configuration/sbx/level2/networking/peering \
  -parallelism 30 \
  -level level2 \
  -env ${caf_environment} \
  -a apply
...
#   -var-folder /tf/caf/mhb-iac-platform/configuration/sbx/level2/networking/pvt_dns \
#   -parallelism 30 \
#   -level level2 \
#   -env ${caf_environment} \
#   -a apply
...
/tf/rover/rover.sh -lz /tf/caf/landingzones/caf_solution \
  ...
  -var-folder /tf/caf/mhb-iac-platform/configuration/sbx/level3/fd_kv \
  -parallelism 30 \
  -level level3 \
  -env ${caf_environment} \
  -a apply
...
/tf/rover/rover.sh -lz /tf/caf/landingzones/caf_solution \
  ...
  -var-folder /tf/caf/mhb-iac-platform/configuration/sbx/level3/102-front_door_advanced \
  -parallelism 30 \
  -level level3 \
  -env ${caf_environment} \
  -a apply
...
/tf/rover/rover.sh -lz /tf/caf/landingzones/caf_solution \
  ...
  -var-folder /tf/caf/mhb-iac-platform/configuration/sbx/level3/210-agw-with-keyvault  \
  -parallelism 30 \
  -level level3 \
  -env ${caf_environment} \
  -a plan
