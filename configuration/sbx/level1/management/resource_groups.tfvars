...
resource_groups = {
  ...
  eus2_la_rg_01 = {
    name   = "mgt-sbx-00-log-00-00-a-rg-00-e2"
    region = "region1"
    tags   = {
  ...
  cus_la_rg_01 = {
    name   = "mgt-sbx-00-log-00-00-a-rg-00-c1"
    region = "region2"
    tags   = {
      "application name"  = "shared services mgt"
      "sbx hours" =  ""
  ...
  eus2_std_rg_01 = {
    name   = "mgt-sbx-00-st-00-00-a-rg-stdiag-e2"
    region = "region1"
    tags   = {
      "application name"  = "shared services mgt"
      "sbx hours" =  ""
  ...
  cus_std_rg_01 = {
    name   = "mgt-sbx-00-st-00-00-a-rg-stdiag-c1"
    region = "region2"
    tags   = {
      "application name"  = "shared services mgt"
      "sbx hours" =  ""
  ...
  // eus2_kv_rg_01 = {
  //   name   = "mgt-sbx-00-kv-00-00-a-rg-kvcmk-e2"
  //   region = "region1"
  //   tags   = {
  //     "application name"  = "shared services mgt"
  //     "sbx hours" =  ""
  ...
  // cus_kv_rg_01 = {
  //   name   = "mgt-sbx-00-kv-00-00-a-rg-kvcmk-c1"
  //   region = "region2"
  //   tags   = {
  //     "application name"  = "shared services mgt"
  //     "sbx hours" =  ""
  ...
  // eus2_evh_rg_01 = {
  //   name   = "pqr-az-ss-sbx-spk-evh-rg001"
  //   region = "region1"
  //   tags   = {
  ...
  // cus_evh_rg_01 = {
  //   name   = "pqr-az-ss-sbx-spk-evh-rg002"
  //   region = "region2"
  //   tags   = {
  //     # "application_id"  =  "<sysid>"
  //     "application_id"    =  "spk"
