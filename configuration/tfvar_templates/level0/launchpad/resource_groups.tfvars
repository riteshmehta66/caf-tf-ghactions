resource_groups = {
  ...
  level0 = {
    name = "caf-{{configs.environment}}-00-ss-cf0-00-mhb-a-rg-00dvops-e2"
    tags = {
  ...
  level1 = {
    name = "caf-{{configs.environment}}-00-ss-cf1-00-mhb-a-rg-00dvops-e2"
    tags = {
  ...
  level2 = {
    name = "caf-{{configs.environment}}-00-ss-cf2-00-mhb-a-rg-00dvops-e2"
    tags = {
  ...
  level3 = {
    name = "caf-{{configs.environment}}-00-ss-cf3-00-mhb-a-rg-00dvops-e2"
    tags = {
  ...
  level4 = {
    name = "caf-{{configs.environment}}-00-ss-cf4-00-mhb-a-rg-00dvops-e2"
    tags = {
