network_security_group_definition = {
  ...
  eus2_nsg_default = {
    ...
    name               = "mgt-sbx-00-ss-00-00-a-nsg-def-e2"    
    version             = 1
    ...
    nsg = [
      ...
      // },
      {
        name                       = "mgt-sbx-non-aks-e2cidr-Allow-e2",
        priority                   = "1000"
        direction                  = "Inbound"
        access                     = "Allow"
        protocol                   = "*"
      ...
      {
        name                       = "mgt-sbx-aks-e2cidr-Allow-e2",
        priority                   = "1001"
        direction                  = "Inbound"
        access                     = "Allow"
        protocol                   = "*"
      ...
      {
        name                       = "mgt-sbx-non-aks-c1cidr-Allow-e2",
        priority                   = "1002"
        direction                  = "Inbound"
        access                     = "Allow"
        protocol                   = "*"
      ...
      {
        name                       = "mgt-sbx-aks-c1cidr-Allow-e2",
        priority                   = "1003"
        direction                  = "Inbound"
        access                     = "Allow"
        protocol                   = "*"
  ...
  cus_nsg_default = {
    ...
    name               = "mgt-sbx-00-ss-00-00-a-nsg-def-c1"    
    version             = 1
    ...
    nsg = [
      ...
      // },
      {
        name                       = "mgt-sbx-non-aks-e2cidr-Allow-c1",
        priority                   = "1000"
        direction                  = "Inbound"
        access                     = "Allow"
        protocol                   = "*"
      ...
      {
        name                       = "mgt-sbx-aks-e2cidr-Allow-c1",
        priority                   = "1001"
        direction                  = "Inbound"
        access                     = "Allow"
        protocol                   = "*"
      ...
      {
        name                       = "mgt-sbx-non-aks-c1cidr-Allow-c1",
        priority                   = "1002"
        direction                  = "Inbound"
        access                     = "Allow"
        protocol                   = "*"
      ...
      {
        name                       = "mgt-sbx-aks-c1cidr-Allow-c1",
        priority                   = "1003"
        direction                  = "Inbound"
        access                     = "Allow"
        protocol                   = "*"
