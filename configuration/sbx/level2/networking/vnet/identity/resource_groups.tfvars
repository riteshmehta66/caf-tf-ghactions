resource_groups = {
  ...
  eus2_vnet_rg_01 = {
    name   = "idm-sbx-00-idm-00-mhb-a-rg-vnet-e2"
    region = "region1"
    tags   = {
  ...
  cus_vnet_rg_01 = {
    name   = "idm-sbx-00-idm-00-mhb-a-rg-vnet-c1"
    region = "region2"
    tags   = {
      "application name"  = "identity services"
      "sbx hours" =  "7:30am-7:30pm est wd's"
  ...
  // eus2_nsg_rg_01 = {
  //   name   = "idm-sbx-00-idm-00-mhb-a-rg-nsg-e2"
  //   region = "region1"  
  // }

  // cus_nsg_rg_01 = {
  //   name   = "idm-sbx-00-idm-00-mhb-a-rg-nsg-c1"
  //   region = "region2"  
  // }
