...
vnet_peerings = {
  ...
  eus2_bynlz_spoke1_TO_eus2_hubvnet = {
    name = "con-sbx-byn-ntw-00-00-a-peer-bys1eh-e2"
    from = {
  ...
  eus2_bynlz_spoke2_TO_eus2_hubvnet = {
    name = "con-sbx-byn-ntw-00-00-a-peer-bys2eh-e2"
    from = {
      // lz_key = "caf_level2_vnets_byn_lz"
  ...
  cus_bynlz_spoke1_TO_cus_hubvnet = {
    name = "con-sbx-byn-ntw-00-00-a-peer-bys1ch-e2"
    from = {
      // lz_key = "caf_level2_vnets_byn_lz"      
  ...
  cus_bynlz_spoke2_TO_cus_hubvnet = {
    name = "con-sbx-byn-ntw-00-00-a-peer-bys2ch-e2"
    from = {
      // lz_key = "caf_level2_vnets_byn_lz"      
